...
- Commit vendor DLL changes only when intentionally versioned; keep `hardware.local.toml`, local hardware addresses, experimental data, and secrets uncommitted.
