...
这些是上次真实读回，不是对当前面板状态的持续保证。当前 TOML 只声明了地址、
参考源、SINE OUT 物理连接、激励和频率，尚未声明全部输入、时间常数、滤波、
灵敏度和 TTL 边沿。
...
### L2 - phase and fixed settings（offline）
